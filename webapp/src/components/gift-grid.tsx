...
export default function GiftGrid({
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold text-center mb-8">{prompt.question}</h1>
                    ...
                    >
                        <div
                            className={cn(
                                ...
                                selectedOccasions.includes(option) && "bg-backgroun"
                            )}
                        >
                            <div className="bg-violet-400 w-full h-full"></div>
                            {/* <Image
                                src={null}
                                alt={option}
