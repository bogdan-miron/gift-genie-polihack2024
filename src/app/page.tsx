  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-14">
        <section id="home" className="w-full py-12 md:py-16 lg:py-26 xl:py-42 bg-gradient-to-b from-white via-transparent to-primary-50">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2 justify-center flex flex-col">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500">
                  Your personal gift-giving assistant. Find the perfect present for any occasion.
                </p>
              </div>
              <div className="w-full max-w-2xl space-y-4 text-center mx-auto">
                <div className="relative w-2/3 sm:w-1/2 md:w-1/3 h-[200px] mx-auto group">
                ...
                <div>
                  ...
                  <p className="mx-auto max-w-[700px] text-gray-500">
                    Start your gift-finding journey today and make your loved ones smile.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-primary-50 via-primary-100 to-primary-100">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border-primary-200 p-4 rounded-lg">
                ...
                <h3 className="text-xl font-bold">Tell Us About the Recipient</h3>
              ...
              <div className="flex flex-col items-center space-y-2 border-primary-200 p-4 rounded-lg">
                ...
                <h3 className="text-xl font-bold">Get Personalized Suggestions</h3>
                <p className="text-gray-500 text-center">
        ...
        <section id="why-choose-us" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-primary-100 via-transparent to-white">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8">
        ...
        <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t from-white via-primary-50 to-primary-100">
          <p className="text-xs text-gray-500">© 2023 Gift Genie. All rights reserved.</p>
